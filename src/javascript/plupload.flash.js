	...
	plupload.runtimes.Flash = plupload.addRuntime("flash", {
		...
		init : function(uploader, callback) {
			...
			function getFlashObj() {
				return getElementByIdOpt(uploader.id + '_flash');
			}
			...
			uploader.bind("Destroy", function(up) {
				...
				flashContainer = getElementByIdOpt(up.id + '_flash_container');
				if (flashContainer) {
			...
			uploader.bind("Flash:Init", function() {				
				...
				uploader.bind("Refresh", function(up) {
					...
					if (browseButton) {
						...
						plupload.extend(getElementByIdOpt(up.id + '_flash_container').style, {
							top : browsePos.y + 'px',
							left : browsePos.x + 'px',
